...
clipper::MMonomer NucleicAcid::mmonomer() const
{
  ...
  if (!coord_p().is_null()) ma_p.set_coord_orth( coord_p() );
  if (!coord_n().is_null()) ma_n.set_coord_orth( coord_n() );
  if (!coord_o5().is_null()) mao5.set_coord_orth( coord_o5() );
  if (!coord_o4().is_null()) mao4.set_coord_orth( coord_o4() );
  if (!coord_o3().is_null()) mao3.set_coord_orth( coord_o3() );
  if (!coord_c5().is_null()) mac5.set_coord_orth( coord_c5() );
  if (!coord_c4().is_null()) mac4.set_coord_orth( coord_c4() );
  if (!coord_c3().is_null()) mac3.set_coord_orth( coord_c3() );
  if (!coord_c2().is_null()) mac2.set_coord_orth( coord_c2() );
  if (!coord_c1().is_null()) mac1.set_coord_orth( coord_c1() );
